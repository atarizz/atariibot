...
const getRegisteredRandomId = () => {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const FarhanGans = ["5571987021257@s.whatsapp.net"] // apenas mude esta tudo bem
			...
			const ownerNumber = ["5571987021257@s.whatsapp.net"] // owner number ubah aja
